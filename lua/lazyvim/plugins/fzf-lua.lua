-- TODO: What does this do? It is passed to fzf-lua symbols functions
...
return {
  ...
  opts = function(_, opts)
    ...
    -- Trouble
    local trouble_plugin_status, trouble_plugin = pcall(require, 'trouble.nvim')
    if trouble_plugin_status then
      config.defaults.actions.files['ctrl-t'] = trouble_plugin.actions.open
    end
    ...
    config.defaults.actions.files['ctrl-r'] = function(_, ctx)
      ...
      -- FIXME: replace with the correct fzf-lua command
  ...
  keys = {
    ...
    { '<leader>fF', 'lua FzfLua.files({ root = false })<cr>', desc = 'Find Files (cwd)' },
    { '<leader>fg', '<cmd>FzfLua git_files<cr>', desc = 'Find Files (git-files)' },
    { '<leader>fr', '<cmd>FzfLua oldfiles<cr>', desc = 'Recent' },
    { '<leader>fR', '<cmd>lua FzfLua.oldfiles({ cwd = vim.uv.cwd() })<cr>', desc = 'Recent (cwd)' },
    -- git
